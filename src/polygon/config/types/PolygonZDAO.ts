...
export interface PolygonZDAOInterface extends utils.Interface {
  ...
  functions: {
    ...
    "__ZDAO_init(address,address,uint256,uint256,uint256,address)": FunctionFragment;
...
export interface PolygonZDAO extends BaseContract {
  ...
  functions: {
    ...
    votesResultOfProposal(
      ...
      [BigNumber, BigNumber[]] & { voters: BigNumber; votes: BigNumber[] }
    >;
